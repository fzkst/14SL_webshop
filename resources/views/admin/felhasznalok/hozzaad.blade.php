...
@section('content')
    <div class="card">
        ...
        <div class="card-body" id="kategoria_urlap">
            <form action="{{ url('felhasznalo_store')}} " method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="checkbox" class="form-check-control" name="maganszemely" value="{{ old('maganszemely') }}">
                    </div>
                    <div class="col-md-6">
